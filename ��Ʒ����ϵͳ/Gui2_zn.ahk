...
Gui, 2:Add, Text, x6 y90 w70 h20 , 功能
Gui, 2:Add, Edit, x86 y90 w100 h50 vAbility,
Gui, 2:Add, Text, x6 y170 w70 h20 , 材质
Gui, 2:Add, Edit, x86 y170 w100 h20 vMaterial,
Gui, 2:Add, Text, x6 y210 w70 h20 , 产品重量
Gui, 2:Add, Edit, x86 y210 w100 h20 vWeight,
Gui, 2:Add, Text, x6 y250 w70 h20 , 适用年龄
Gui, 2:Add, Edit, x86 y250 w100 h20 vAge, 3岁以上
Gui, 2:Add, Text, x6 y290 w70 h20 , 产品包装
Gui, 2:Add, Edit, x86 y290 w100 h20 vPackage, 纸盒
